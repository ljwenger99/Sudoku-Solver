...
class Sudoku:
    ...
    def __init__(self, nums):
        ...
        # Collection of functions for easy reference to rows, cols, and blocks -- ex: _row(1) refers to the first row of the physical puzzle
        def _row(self, a):
...
# TO DO: Fix the open single and do the same for cols and blocks
